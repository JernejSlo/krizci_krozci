...
class gluon_moveit():
    ...
    def __init__(self):
        ...
        self.board_position = [self.to_rad(-22), self.to_rad(3), self.to_rad(-106), self.to_rad(-19), self.to_rad(-88), self.to_rad(-35)]
...
if __name__ == '__main__':
    ...
    gluon_moveit_obj = gluon_moveit()
    try:
        #gluon_moveit_obj.get_basic_info()
        gluon_moveit_obj.move_above_board()
